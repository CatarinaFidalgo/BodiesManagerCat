...
public enum BodyJointType //enum used to declare list of named integer constants. Used to give a name to each constant so that the integer can be referred using its name. In this case head = 0, neck 0 1 ...
{
	head,
...
public enum BodyPropertiesType  //Perguntar o que é
{
	UID, //user ID
	HandLeftState,
	HandLeftConfidence,  //Confidence is the degree of quality of the tracked hand
	HandRightState,
	HandRightConfidence
}
